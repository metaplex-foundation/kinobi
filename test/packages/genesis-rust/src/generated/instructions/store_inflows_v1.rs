...
impl StoreInflowsV1 {
    pub fn instruction(
        &self,
        args: StoreInflowsV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(StoreInflowsV1InstructionData::new())).unwrap();
...
pub struct StoreInflowsV1InstructionData {
    discriminator: u8,
}

impl StoreInflowsV1InstructionData {
    pub fn new() -> Self {
...
pub struct StoreInflowsV1InstructionArgs {
    pub index: u8,
    pub padding: [u8; 6],
}

/// Instruction builder for `StoreInflowsV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct StoreInflowsV1Builder {
...
impl StoreInflowsV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = StoreInflowsV1InstructionArgs {
...
/// `store_inflows_v1` CPI accounts.
pub struct StoreInflowsV1CpiAccounts<'a, 'b> {
    /// The address of the genesis account
...
/// `store_inflows_v1` CPI instruction.
pub struct StoreInflowsV1Cpi<'a, 'b> {
    ...
    pub __args: StoreInflowsV1InstructionArgs,
}

impl<'a, 'b> StoreInflowsV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: StoreInflowsV1CpiAccounts<'a, 'b>,
        args: StoreInflowsV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `StoreInflowsV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` genesis_account
...
///   4. `[writable]` fee_wallet
///   5. `[]` system_program
pub struct StoreInflowsV1CpiBuilder<'a, 'b> {
    instruction: Box<StoreInflowsV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> StoreInflowsV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(StoreInflowsV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = StoreInflowsV1Cpi {
...
struct StoreInflowsV1CpiBuilderInstruction<'a, 'b> {
