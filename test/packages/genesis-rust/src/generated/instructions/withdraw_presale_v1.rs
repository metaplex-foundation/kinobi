...
impl WithdrawPresaleV1 {
    pub fn instruction(
        &self,
        args: WithdrawPresaleV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(WithdrawPresaleV1InstructionData::new())).unwrap();
...
pub struct WithdrawPresaleV1InstructionData {
    discriminator: u8,
}

impl WithdrawPresaleV1InstructionData {
    pub fn new() -> Self {
...
pub struct WithdrawPresaleV1InstructionArgs {
    pub index: u8,
    pub padding: [u8; 6],
}

/// Instruction builder for `WithdrawPresaleV1`.
///
/// ### Accounts:
///
///   0. `[]` genesis_account
...
#[derive(Default)]
pub struct WithdrawPresaleV1Builder {
...
impl WithdrawPresaleV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = WithdrawPresaleV1 {
        ...
        let args = WithdrawPresaleV1InstructionArgs {
...
/// `withdraw_presale_v1` CPI accounts.
pub struct WithdrawPresaleV1CpiAccounts<'a, 'b> {
    /// The address of the genesis account
...
/// `withdraw_presale_v1` CPI instruction.
pub struct WithdrawPresaleV1Cpi<'a, 'b> {
    ...
    pub __args: WithdrawPresaleV1InstructionArgs,
}

impl<'a, 'b> WithdrawPresaleV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawPresaleV1CpiAccounts<'a, 'b>,
        args: WithdrawPresaleV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawPresaleV1` via CPI.
///
/// ### Accounts:
///
///   0. `[]` genesis_account
...
///   8. `[]` token_program
///   9. `[signer, optional]` backend_signer
pub struct WithdrawPresaleV1CpiBuilder<'a, 'b> {
    instruction: Box<WithdrawPresaleV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawPresaleV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawPresaleV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawPresaleV1Cpi {
...
struct WithdrawPresaleV1CpiBuilderInstruction<'a, 'b> {
