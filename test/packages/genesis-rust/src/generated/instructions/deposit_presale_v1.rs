...
impl DepositPresaleV1 {
    pub fn instruction(
        &self,
        args: DepositPresaleV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(DepositPresaleV1InstructionData::new())).unwrap();
...
pub struct DepositPresaleV1InstructionData {
    discriminator: u8,
}

impl DepositPresaleV1InstructionData {
    pub fn new() -> Self {
...
pub struct DepositPresaleV1InstructionArgs {
    pub index: u8,
    pub padding: [u8; 6],
    pub amount: u64,
}

/// Instruction builder for `DepositPresaleV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct DepositPresaleV1Builder {
...
impl DepositPresaleV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DepositPresaleV1InstructionArgs {
...
/// `deposit_presale_v1` CPI accounts.
pub struct DepositPresaleV1CpiAccounts<'a, 'b> {
    /// The address of the genesis account
...
/// `deposit_presale_v1` CPI instruction.
pub struct DepositPresaleV1Cpi<'a, 'b> {
    ...
    pub __args: DepositPresaleV1InstructionArgs,
}

impl<'a, 'b> DepositPresaleV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DepositPresaleV1CpiAccounts<'a, 'b>,
        args: DepositPresaleV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DepositPresaleV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` genesis_account
...
///   10. `[]` system_program
///   11. `[signer, optional]` backend_signer
pub struct DepositPresaleV1CpiBuilder<'a, 'b> {
    instruction: Box<DepositPresaleV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositPresaleV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DepositPresaleV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DepositPresaleV1Cpi {
...
struct DepositPresaleV1CpiBuilderInstruction<'a, 'b> {
