...
impl FinalizeV2 {
    pub fn instruction(
        &self,
        args: FinalizeV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(FinalizeV2InstructionData::new())).unwrap();
...
pub struct FinalizeV2InstructionData {
    discriminator: u8,
}

impl FinalizeV2InstructionData {
    pub fn new() -> Self {
...
pub struct FinalizeV2InstructionArgs {
    pub padding: [u8; 7],
}

/// Instruction builder for `FinalizeV2`.
///
/// ### Accounts:
///
...
impl FinalizeV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = FinalizeV2InstructionArgs {
...
/// `finalize_v2` CPI accounts.
pub struct FinalizeV2CpiAccounts<'a, 'b> {
    /// The address of the genesis account
...
/// `finalize_v2` CPI instruction.
pub struct FinalizeV2Cpi<'a, 'b> {
    ...
    pub __args: FinalizeV2InstructionArgs,
}

impl<'a, 'b> FinalizeV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: FinalizeV2CpiAccounts<'a, 'b>,
        args: FinalizeV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FinalizeV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` genesis_account
///   1. `[writable]` base_mint
///   2. `[signer]` authority
pub struct FinalizeV2CpiBuilder<'a, 'b> {
    instruction: Box<FinalizeV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> FinalizeV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(FinalizeV2CpiBuilderInstruction {
            __program: program,
...
struct FinalizeV2CpiBuilderInstruction<'a, 'b> {
