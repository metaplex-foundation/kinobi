...
impl ClaimUnlockedV1 {
    pub fn instruction(
        &self,
        args: ClaimUnlockedV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(ClaimUnlockedV1InstructionData::new())).unwrap();
...
pub struct ClaimUnlockedV1InstructionData {
    discriminator: u8,
}

impl ClaimUnlockedV1InstructionData {
    pub fn new() -> Self {
...
pub struct ClaimUnlockedV1InstructionArgs {
    pub index: u8,
    pub padding: [u8; 6],
}

/// Instruction builder for `ClaimUnlockedV1`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct ClaimUnlockedV1Builder {
...
impl ClaimUnlockedV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = ClaimUnlockedV1InstructionArgs {
...
/// `claim_unlocked_v1` CPI accounts.
pub struct ClaimUnlockedV1CpiAccounts<'a, 'b> {
    /// The address of the genesis account
...
/// `claim_unlocked_v1` CPI instruction.
pub struct ClaimUnlockedV1Cpi<'a, 'b> {
    ...
    pub __args: ClaimUnlockedV1InstructionArgs,
}

impl<'a, 'b> ClaimUnlockedV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ClaimUnlockedV1CpiAccounts<'a, 'b>,
        args: ClaimUnlockedV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClaimUnlockedV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` genesis_account
...
///   11. `[]` system_program
///   12. `[signer, optional]` backend_signer
pub struct ClaimUnlockedV1CpiBuilder<'a, 'b> {
    instruction: Box<ClaimUnlockedV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimUnlockedV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimUnlockedV1CpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ClaimUnlockedV1Cpi {
...
struct ClaimUnlockedV1CpiBuilderInstruction<'a, 'b> {
