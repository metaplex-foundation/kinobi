...
export function getSetAndVerifyCollectionInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<SetAndVerifyCollectionInstructionArgsOnly>([], {
    description: 'SetAndVerifyCollectionInstructionArgsOnly',
