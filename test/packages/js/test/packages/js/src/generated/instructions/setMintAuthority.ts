...
export function getSetMintAuthorityInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<SetMintAuthorityInstructionArgsOnly>([], {
    description: 'SetMintAuthorityInstructionArgsOnly',
