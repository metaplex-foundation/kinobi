...
export function getUnverifySizedCollectionItemInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<UnverifySizedCollectionItemInstructionArgsOnly>([], {
    description: 'UnverifySizedCollectionItemInstructionArgsOnly',
