...
export function getRevokeUseAuthorityInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<RevokeUseAuthorityInstructionArgsOnly>([], {
    description: 'RevokeUseAuthorityInstructionArgsOnly',
