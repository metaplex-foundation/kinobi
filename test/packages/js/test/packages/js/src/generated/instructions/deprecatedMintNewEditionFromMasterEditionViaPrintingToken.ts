...
export function getDeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionArgsOnlySerializer(): Serializer<
  ...
  any
> {
  return struct<DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionArgsOnly>(
    [],
    {
      description:
        'DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionArgsOnly',
    }
