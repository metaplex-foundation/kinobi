...
export function getDeprecatedMintPrintingTokensViaTokenInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<DeprecatedMintPrintingTokensViaTokenInstructionArgsOnly>(
    [
      [
        'mintPrintingTokensViaTokenArgs',
        getMintPrintingTokensViaTokenArgsSerializer(),
    ...
    { description: 'DeprecatedMintPrintingTokensViaTokenInstructionArgsOnly' }
