...
export function getVerifySizedCollectionItemInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<VerifySizedCollectionItemInstructionArgsOnly>([], {
    description: 'VerifySizedCollectionItemInstructionArgsOnly',
