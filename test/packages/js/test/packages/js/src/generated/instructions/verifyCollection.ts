...
export function getVerifyCollectionInstructionArgsOnlySerializer(): Serializer<
  any,
  any
> {
  return struct<VerifyCollectionInstructionArgsOnly>([], {
    description: 'VerifyCollectionInstructionArgsOnly',
