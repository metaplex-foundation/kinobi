...
impl TransferOutOfEscrow {
  pub fn instruction(&self, args: TransferOutOfEscrowInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: TransferOutOfEscrowInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
#[inline(always)]
    pub fn payer(&mut self, payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Mint account for the new attribute
#[inline(always)]
    pub fn attribute_mint(&mut self, attribute_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.attribute_mint = Some(attribute_mint);
                    self
    }
      /// Token account source for the new attribute
#[inline(always)]
    pub fn attribute_src(&mut self, attribute_src: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.attribute_src = Some(attribute_src);
                    self
    }
      /// Token account, owned by TM, destination for the new attribute
#[inline(always)]
    pub fn attribute_dst(&mut self, attribute_dst: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.attribute_dst = Some(attribute_dst);
                    self
    }
      /// Mint account that the escrow is attached
#[inline(always)]
    pub fn escrow_mint(&mut self, escrow_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.escrow_mint = Some(escrow_mint);
                    self
    }
      /// Token account that holds the token the escrow is attached to
#[inline(always)]
    pub fn escrow_account(&mut self, escrow_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          attribute_mint: self.instruction.attribute_mint.expect("attribute_mint is not set"),
                  
          attribute_src: self.instruction.attribute_src.expect("attribute_src is not set"),
                  
          attribute_dst: self.instruction.attribute_dst.expect("attribute_dst is not set"),
                  
          escrow_mint: self.instruction.escrow_mint.expect("escrow_mint is not set"),
                  
          escrow_account: self.instruction.escrow_account.expect("escrow_account is not set"),
