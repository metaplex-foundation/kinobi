...
impl<'a, 'b> SetCollectionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn candy_machine(&mut self, candy_machine: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn authority(&mut self, authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn authority_pda(&mut self, authority_pda: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn payer(&mut self, payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn collection_mint(&mut self, collection_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn collection_authority_record(&mut self, collection_authority_record: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn new_collection_update_authority(&mut self, new_collection_update_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_collection_update_authority = Some(new_collection_update_authority);
                    self
    }
      #[inline(always)]
    pub fn new_collection_metadata(&mut self, new_collection_metadata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_collection_metadata = Some(new_collection_metadata);
                    self
    }
      #[inline(always)]
    pub fn new_collection_mint(&mut self, new_collection_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_collection_mint = Some(new_collection_mint);
                    self
    }
      #[inline(always)]
    pub fn new_collection_master_edition(&mut self, new_collection_master_edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_collection_master_edition = Some(new_collection_master_edition);
                    self
    }
      #[inline(always)]
    pub fn new_collection_authority_record(&mut self, new_collection_authority_record: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          candy_machine: self.instruction.candy_machine.expect("candy_machine is not set"),
          ...
          collection_mint: self.instruction.collection_mint.expect("collection_mint is not set"),
          ...
          new_collection_update_authority: self.instruction.new_collection_update_authority.expect("new_collection_update_authority is not set"),
                  
          new_collection_metadata: self.instruction.new_collection_metadata.expect("new_collection_metadata is not set"),
                  
          new_collection_mint: self.instruction.new_collection_mint.expect("new_collection_mint is not set"),
                  
          new_collection_master_edition: self.instruction.new_collection_master_edition.expect("new_collection_master_edition is not set"),
                  
          new_collection_authority_record: self.instruction.new_collection_authority_record.expect("new_collection_authority_record is not set"),
