...
impl Delegate {
  pub fn instruction(&self, args: DelegateInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DelegateInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
/// SPL Token Program
#[inline(always)]
    pub fn spl_token_program(&mut self, spl_token_program: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
...
impl<'a, 'b> DelegateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// Delegate account key (pda of [mint id, delegate role, user id, authority id])
#[inline(always)]
    pub fn delegate_record(&mut self, delegate_record: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
/// Owned Token Account of mint
#[inline(always)]
    pub fn token(&mut self, token: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
/// SPL Token Program
#[inline(always)]
    pub fn spl_token_program(&mut self, spl_token_program: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DelegateInstructionArgs {
                                                              delegate_args: self.instruction.delegate_args.clone().expect("delegate_args is not set"),
                                    };
        let instruction = DelegateCpi {
        __program: self.instruction.__program,
                  
          delegate_record: self.instruction.delegate_record.expect("delegate_record is not set"),
