...
impl MintNewEditionFromMasterEditionViaVaultProxy {
  pub fn instruction(&self, args: MintNewEditionFromMasterEditionViaVaultProxyInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: MintNewEditionFromMasterEditionViaVaultProxyInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(MintNewEditionFromMasterEditionViaVaultProxyInstructionData::new())).unwrap();
...
#[inline(always)]
    pub fn rent(&mut self, rent: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
      ...
      pub fn mint_new_edition_from_master_edition_via_token_args(&mut self, mint_new_edition_from_master_edition_via_token_args: MintNewEditionFromMasterEditionViaTokenArgs) -> &mut Self {
        self.mint_new_edition_from_master_edition_via_token_args = Some(mint_new_edition_from_master_edition_via_token_args);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = MintNewEditionFromMasterEditionViaVaultProxy {
          ...
          let args = MintNewEditionFromMasterEditionViaVaultProxyInstructionArgs {
                                                              mint_new_edition_from_master_edition_via_token_args: self.mint_new_edition_from_master_edition_via_token_args.clone().expect("mint_new_edition_from_master_edition_via_token_args is not set"),
                                    };
...
impl<'a, 'b> MintNewEditionFromMasterEditionViaVaultProxyCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(MintNewEditionFromMasterEditionViaVaultProxyCpiBuilderInstruction {
      __program: program,
              new_metadata: None,
              new_edition: None,
              master_edition: None,
    ...
    Self { instruction }
      ...
      /// New Metadata key (pda of ['metadata', program id, mint id])
#[inline(always)]
    pub fn new_metadata(&mut self, new_metadata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_metadata = Some(new_metadata);
                    self
    }
      /// New Edition (pda of ['metadata', program id, mint id, 'edition'])
#[inline(always)]
    pub fn new_edition(&mut self, new_edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn master_edition(&mut self, master_edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Mint of new token - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY
#[inline(always)]
    pub fn new_mint(&mut self, new_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.new_mint = Some(new_mint);
                    self
    }
      /// Edition pda to mark creation - will be checked for pre-existence. (pda of ['metadata', program id, master metadata mint id, 'edition', edition_number]) where edition_number is NOT the edition number you pass in args but actually edition_number = floor(edition/EDITION_MARKER_BIT_SIZE).
#[inline(always)]
    pub fn edition_mark_pda(&mut self, edition_mark_pda: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.edition_mark_pda = Some(edition_mark_pda);
                    self
    }
      /// Mint authority of new mint
#[inline(always)]
    pub fn new_mint_authority(&mut self, new_mint_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn vault_authority(&mut self, vault_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Safety deposit token store account
#[inline(always)]
    pub fn safety_deposit_store(&mut self, safety_deposit_store: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.safety_deposit_store = Some(safety_deposit_store);
                    self
    }
      /// Safety deposit box
#[inline(always)]
    pub fn safety_deposit_box(&mut self, safety_deposit_box: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn vault(&mut self, vault: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Update authority info for new metadata
#[inline(always)]
    pub fn new_metadata_update_authority(&mut self, new_metadata_update_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn token_program(&mut self, token_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Token vault program
#[inline(always)]
    pub fn token_vault_program(&mut self, token_vault_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn rent(&mut self, rent: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn mint_new_edition_from_master_edition_via_token_args(&mut self, mint_new_edition_from_master_edition_via_token_args: MintNewEditionFromMasterEditionViaTokenArgs) -> &mut Self {
        self.instruction.mint_new_edition_from_master_edition_via_token_args = Some(mint_new_edition_from_master_edition_via_token_args);
        self
      }
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = MintNewEditionFromMasterEditionViaVaultProxyInstructionArgs {
                                                              mint_new_edition_from_master_edition_via_token_args: self.instruction.mint_new_edition_from_master_edition_via_token_args.clone().expect("mint_new_edition_from_master_edition_via_token_args is not set"),
                                    };
        let instruction = MintNewEditionFromMasterEditionViaVaultProxyCpi {
        __program: self.instruction.__program,
                  
          new_metadata: self.instruction.new_metadata.expect("new_metadata is not set"),
                  
          new_edition: self.instruction.new_edition.expect("new_edition is not set"),
          ...
          edition_mark_pda: self.instruction.edition_mark_pda.expect("edition_mark_pda is not set"),
                  
          new_mint_authority: self.instruction.new_mint_authority.expect("new_mint_authority is not set"),
                  
          payer: self.instruction.payer.expect("payer is not set"),
                  
          vault_authority: self.instruction.vault_authority.expect("vault_authority is not set"),
                  
          safety_deposit_store: self.instruction.safety_deposit_store.expect("safety_deposit_store is not set"),
                  
          safety_deposit_box: self.instruction.safety_deposit_box.expect("safety_deposit_box is not set"),
                  
          vault: self.instruction.vault.expect("vault is not set"),
                  
          new_metadata_update_authority: self.instruction.new_metadata_update_authority.expect("new_metadata_update_authority is not set"),
                  
          metadata: self.instruction.metadata.expect("metadata is not set"),
                  
          token_program: self.instruction.token_program.expect("token_program is not set"),
                  
          token_vault_program: self.instruction.token_vault_program.expect("token_vault_program is not set"),
