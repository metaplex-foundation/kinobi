...
impl CreateMetadataAccount {
  pub fn instruction(&self, args: CreateMetadataAccountInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateMetadataAccountInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(CreateMetadataAccountInstructionData::new())).unwrap();
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CreateMetadataAccountInstructionArgs {
                                                              data: self.instruction.data.clone().expect("data is not set"),
                                                                  is_mutable: self.instruction.is_mutable.clone().expect("is_mutable is not set"),
