...
impl DeprecatedMintPrintingTokensViaToken {
  pub fn instruction(&self, args: DeprecatedMintPrintingTokensViaTokenInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DeprecatedMintPrintingTokensViaTokenInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(DeprecatedMintPrintingTokensViaTokenInstructionData::new())).unwrap();
...
#[inline(always)]
    pub fn rent(&mut self, rent: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn mint_printing_tokens_via_token_args(&mut self, mint_printing_tokens_via_token_args: MintPrintingTokensViaTokenArgs) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DeprecatedMintPrintingTokensViaToken {
          ...
          let args = DeprecatedMintPrintingTokensViaTokenInstructionArgs {
                                                              mint_printing_tokens_via_token_args: self.mint_printing_tokens_via_token_args.clone().expect("mint_printing_tokens_via_token_args is not set"),
                                    };
...
#[inline(always)]
    pub fn printing_mint(&mut self, printing_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Burn authority
#[inline(always)]
    pub fn burn_authority(&mut self, burn_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn rent(&mut self, rent: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn mint_printing_tokens_via_token_args(&mut self, mint_printing_tokens_via_token_args: MintPrintingTokensViaTokenArgs) -> &mut Self {
        self.instruction.mint_printing_tokens_via_token_args = Some(mint_printing_tokens_via_token_args);
        self
      }
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DeprecatedMintPrintingTokensViaTokenInstructionArgs {
                                                              mint_printing_tokens_via_token_args: self.instruction.mint_printing_tokens_via_token_args.clone().expect("mint_printing_tokens_via_token_args is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          burn_authority: self.instruction.burn_authority.expect("burn_authority is not set"),
