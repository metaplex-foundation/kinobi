...
#[inline(always)]
    pub fn master_edition(&mut self, master_edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// One time authorization mint
#[inline(always)]
    pub fn one_time_auth(&mut self, one_time_auth: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          one_time_auth: self.instruction.one_time_auth.expect("one_time_auth is not set"),
