...
impl DeprecatedSetReservationList {
  pub fn instruction(&self, args: DeprecatedSetReservationListInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DeprecatedSetReservationListInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(DeprecatedSetReservationListInstructionData::new())).unwrap();
    ...
    let accounts = DeprecatedSetReservationList {
          ...
          let args = DeprecatedSetReservationListInstructionArgs {
                                                              reservations: self.reservations.clone().expect("reservations is not set"),
                                                                  ...
                                                                  total_spot_offset: self.total_spot_offset.clone().expect("total_spot_offset is not set"),
                                    };
...
#[inline(always)]
    pub fn master_edition(&mut self, master_edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// PDA for ReservationList of ['metadata', program id, master edition key, 'reservation', resource-key]
#[inline(always)]
    pub fn reservation_list(&mut self, reservation_list: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.reservation_list = Some(reservation_list);
                    self
    }
      /// The resource you tied the reservation list too
#[inline(always)]
    pub fn resource(&mut self, resource: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DeprecatedSetReservationListInstructionArgs {
                                                              reservations: self.instruction.reservations.clone().expect("reservations is not set"),
                                                                  ...
                                                                  total_spot_offset: self.instruction.total_spot_offset.clone().expect("total_spot_offset is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          reservation_list: self.instruction.reservation_list.expect("reservation_list is not set"),
