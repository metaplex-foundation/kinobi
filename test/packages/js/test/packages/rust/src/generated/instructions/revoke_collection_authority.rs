...
#[inline(always)]
    pub fn delegate_authority(&mut self, delegate_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Update Authority, or Delegated Authority, of Collection NFT
#[inline(always)]
    pub fn revoke_authority(&mut self, revoke_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          revoke_authority: self.instruction.revoke_authority.expect("revoke_authority is not set"),
