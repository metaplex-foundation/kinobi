...
impl UseAsset {
  pub fn instruction(&self, args: UseAssetInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UseAssetInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
/// Use Authority Record PDA (if present the program assumes a delegated use authority)
#[inline(always)]
    pub fn use_authority_record(&mut self, use_authority_record: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = UseAsset {
          ...
          let args = UseAssetInstructionArgs {
                                                              use_asset_args: self.use_asset_args.clone().expect("use_asset_args is not set"),
                                    };
...
#[inline(always)]
    pub fn mint(&mut self, mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Use authority or current owner of the asset
#[inline(always)]
    pub fn use_authority(&mut self, use_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
/// Use Authority Record PDA (if present the program assumes a delegated use authority)
#[inline(always)]
    pub fn use_authority_record(&mut self, use_authority_record: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = UseAssetInstructionArgs {
                                                              use_asset_args: self.instruction.use_asset_args.clone().expect("use_asset_args is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          use_authority: self.instruction.use_authority.expect("use_authority is not set"),
