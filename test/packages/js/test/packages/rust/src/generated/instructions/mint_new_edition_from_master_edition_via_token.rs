...
impl MintNewEditionFromMasterEditionViaToken {
  pub fn instruction(&self, args: MintNewEditionFromMasterEditionViaTokenInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: MintNewEditionFromMasterEditionViaTokenInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(MintNewEditionFromMasterEditionViaTokenInstructionData::new())).unwrap();
...
impl<'a, 'b> MintNewEditionFromMasterEditionViaTokenCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(MintNewEditionFromMasterEditionViaTokenCpiBuilderInstruction {
      __program: program,
              new_metadata: None,
              new_edition: None,
              master_edition: None,
