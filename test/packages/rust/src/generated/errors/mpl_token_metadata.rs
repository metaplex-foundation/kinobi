...
pub enum MplTokenMetadataError {
    ...
    #[error("The mint on your authorization token holding account does not match your Printing mint!")]
    ...
    #[error("Can't burn a verified member of a collection w/o providing collection metadata account")]
...
impl TryFrom<u32> for MplTokenMetadataError {
    ...
    fn try_from(error: u32) -> Result<Self, Self::Error> {
        match error {
                            ...
                            133 => Ok(MplTokenMetadataError::MintIsNotSigner),
                            134 => Ok(MplTokenMetadataError::InvalidTokenStandard),
                            135 => Ok(MplTokenMetadataError::InvalidMintForTokenStandard),
                            136 => Ok(MplTokenMetadataError::InvalidAuthorizationRules),
                            137 => Ok(MplTokenMetadataError::MissingAuthorizationRules),
                            138 => Ok(MplTokenMetadataError::MissingProgrammableConfig),
                            139 => Ok(MplTokenMetadataError::InvalidProgrammableConfig),
                            140 => Ok(MplTokenMetadataError::DelegateAlreadyExists),
                            141 => Ok(MplTokenMetadataError::DelegateNotFound),
                            142 => Ok(MplTokenMetadataError::MissingAccountInBuilder),
                            143 => Ok(MplTokenMetadataError::MissingArgumentInBuilder),
                            144 => Ok(MplTokenMetadataError::FeatureNotSupported),
                            145 => Ok(MplTokenMetadataError::InvalidSystemWallet),
                            146 => Ok(MplTokenMetadataError::OnlySaleDelegateCanTransfer),
                            147 => Ok(MplTokenMetadataError::MissingTokenAccount),
                            148 => Ok(MplTokenMetadataError::MissingSplTokenProgram),
                            149 => Ok(MplTokenMetadataError::MissingAuthorizationRulesProgram),
                            150 => Ok(MplTokenMetadataError::InvalidDelegateRoleForTransfer),
...
impl ToStr for MplTokenMetadataError {
    fn to_str(&self) -> &'static str {
        match self {
                            MplTokenMetadataError::InstructionUnpackError => "Failed to unpack instruction data",
                            MplTokenMetadataError::InstructionPackError => "Failed to pack instruction data",
                            ...
                            MplTokenMetadataError::UpdateAuthorityMustBeEqualToMetadataAuthorityAndSigner => "Update authority must be equivalent to the metadata's authority and also signer of this transaction",
                            ...
                            MplTokenMetadataError::MaxEditionsMintedAlready => "Maximum editions printed already",
                            MplTokenMetadataError::TokenMintToFailed => "Token mint to failed",
                            MplTokenMetadataError::MasterRecordMismatch => "The master edition record passed must match the master record on the edition given",
                            MplTokenMetadataError::DestinationMintMismatch => "The destination account does not have the right mint",
                            MplTokenMetadataError::EditionAlreadyMinted => "An edition can only mint one of its kind!",
                            MplTokenMetadataError::PrintingMintDecimalsShouldBeZero => "Printing mint decimals should be zero",
                            MplTokenMetadataError::OneTimePrintingAuthorizationMintDecimalsShouldBeZero => "OneTimePrintingAuthorization mint decimals should be zero",
                            MplTokenMetadataError::EditionMintDecimalsShouldBeZero => "EditionMintDecimalsShouldBeZero",
                            MplTokenMetadataError::TokenBurnFailed => "Token burn failed",
                            MplTokenMetadataError::TokenAccountOneTimeAuthMintMismatch => "The One Time authorization mint does not match that on the token account!",
                            ...
                            MplTokenMetadataError::PrintingMintAuthorizationAccountMismatch => "The mint on your authorization token holding account does not match your Printing mint!",
                            MplTokenMetadataError::AuthorizationTokenAccountOwnerMismatch => "The authorization token account has a different owner than the update authority for the master edition!",
                            MplTokenMetadataError::Disabled => "This feature is currently disabled.",
                            ...
                            MplTokenMetadataError::MustBeOneOfCreators => "If using a creators array, you must be one of the creators listed",
                            ...
                            MplTokenMetadataError::ReservationExists => "This reservation list already exists!",
                            MplTokenMetadataError::ReservationDoesNotExist => "This reservation list does not exist!",
                            MplTokenMetadataError::ReservationNotSet => "This reservation list exists but was never set with reservations",
                            MplTokenMetadataError::ReservationAlreadyMade => "This reservation list has already been set!",
                            MplTokenMetadataError::BeyondMaxAddressSize => "Provided more addresses than max allowed in single reservation",
                            MplTokenMetadataError::NumericalOverflowError => "NumericalOverflowError",
                            MplTokenMetadataError::ReservationBreachesMaximumSupply => "This reservation would go beyond the maximum supply of the master edition!",
                            MplTokenMetadataError::AddressNotInReservation => "Address not in reservation!",
                            ...
                            MplTokenMetadataError::SpotMismatch => "In initial reservation setting, spots remaining should equal total spots",
                            MplTokenMetadataError::IncorrectOwner => "Incorrect account owner",
                            MplTokenMetadataError::PrintingWouldBreachMaximumSupply => "printing these tokens would breach the maximum supply limit of the master edition",
                            ...
                            MplTokenMetadataError::ReservationSpotsRemainingShouldMatchTotalSpotsAtStart => "Reservation spots remaining should match total spots when first being created",
                            MplTokenMetadataError::InvalidTokenProgram => "Invalid token program",
                            MplTokenMetadataError::DataTypeMismatch => "Data type mismatch",
                            MplTokenMetadataError::BeyondAlottedAddressSize => "Beyond alotted address size in reservation!",
                            MplTokenMetadataError::ReservationNotComplete => "The reservation has only been partially alotted",
                            MplTokenMetadataError::TriedToReplaceAnExistingReservation => "You cannot splice over an existing reservation!",
                            ...
                            MplTokenMetadataError::ReservationArrayShouldBeSizeOne => "In the legacy system the reservation needs to be of size one for cpu limit reasons",
                            ...
                            MplTokenMetadataError::MustBeBurned => "This token use method is burn and there are no remaining uses, it must be burned",
                            ...
                            MplTokenMetadataError::InvalidCollectionAuthorityRecord => "This Collection Authority Record is invalid.",
                            ...
                            MplTokenMetadataError::CannotAdjustVerifiedCreator => "Creator can not be adjusted once they are verified.",
                            MplTokenMetadataError::CannotRemoveVerifiedCreator => "Verified creators cannot be removed.",
                            MplTokenMetadataError::CannotWipeVerifiedCreators => "Can not wipe verified creators.",
                            MplTokenMetadataError::NotAllowedToChangeSellerFeeBasisPoints => "Not allowed to change seller fee basis points.",
                            ...
                            MplTokenMetadataError::TokenCloseFailed => "Token close failed",
                            ...
                            MplTokenMetadataError::MissingCollectionMetadata => "Can't burn a verified member of a collection w/o providing collection metadata account",
                            ...
                            MplTokenMetadataError::BorshDeserializationError => "Borsh Deserialization Error",
                            ...
                            MplTokenMetadataError::AlreadyUnverified => "Item is already unverified.",
                            ...
                            MplTokenMetadataError::MissingAuthorizationRulesProgram => "Missing SPL token program",
