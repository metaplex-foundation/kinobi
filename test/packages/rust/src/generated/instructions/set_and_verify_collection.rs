...
pub mod cpi {
    ...
    pub struct SetAndVerifyCollection<'a> {
    ...
    impl<'a> SetAndVerifyCollection<'a> {
    ...
    pub struct SetAndVerifyCollectionBuilder<'a> {
    ...
    impl<'a> SetAndVerifyCollectionBuilder<'a> {
        ...
        pub fn build(&'a self) -> SetAndVerifyCollection {
