...
pub struct MintSet;
#[derive(Clone)]
pub struct ThawDelegatedAccountUnset;

pub struct ThawDelegatedAccountBuilder<
    DelegateTypeParam = ThawDelegatedAccountUnset,
    TokenAccountTypeParam = ThawDelegatedAccountUnset,
    EditionTypeParam = ThawDelegatedAccountUnset,
    MintTypeParam = ThawDelegatedAccountUnset,
> {
...
impl
    ThawDelegatedAccountBuilder<
        ThawDelegatedAccountUnset,
        ThawDelegatedAccountUnset,
        ThawDelegatedAccountUnset,
        ThawDelegatedAccountUnset,
    >
...
impl ThawDelegatedAccountBuilder<DelegateSet, TokenAccountSet, EditionSet, MintSet> {
