...
pub mod cpi {
    ...
    pub struct MintNewEditionFromMasterEditionViaTokenBuilder<'a> {
    ...
    impl<'a> MintNewEditionFromMasterEditionViaTokenBuilder<'a> {
        ...
        pub fn build(&'a self) -> MintNewEditionFromMasterEditionViaToken {
