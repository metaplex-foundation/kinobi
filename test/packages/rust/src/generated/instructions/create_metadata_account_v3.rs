...
use crate::generated::types::{CollectionDetails, DataV2};
...
pub mod cpi {
    ...
    pub struct CreateMetadataAccountV3<'a> {
        ...
        pub args: CreateMetadataAccountV3InstructionArgs,
    }
    ...
    pub struct CreateMetadataAccountV3Builder<'a> {
    ...
    impl<'a> CreateMetadataAccountV3Builder<'a> {
        ...
        pub fn build(&'a self) -> CreateMetadataAccountV3 {
