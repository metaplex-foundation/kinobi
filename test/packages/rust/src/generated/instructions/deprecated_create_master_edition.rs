...
impl DeprecatedCreateMasterEdition {
  pub fn instruction(&self, args: DeprecatedCreateMasterEditionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DeprecatedCreateMasterEditionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(DeprecatedCreateMasterEditionInstructionData::new())).unwrap();
...
#[inline(always)]
    pub fn one_time_printing_authorization_mint_authority(&mut self, one_time_printing_authorization_mint_authority: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn create_master_edition_args(&mut self, create_master_edition_args: CreateMasterEditionArgs) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DeprecatedCreateMasterEdition {
          ...
          let args = DeprecatedCreateMasterEditionInstructionArgs {
                                                              create_master_edition_args: self.create_master_edition_args.clone().expect("create_master_edition_args is not set"),
                                    };
  ...
  pub struct DeprecatedCreateMasterEditionCpiAccounts<'a, 'b> {
              ...
              pub one_time_printing_authorization_mint_authority: &'b solana_program::account_info::AccountInfo<'a>,
            }
  ...
  pub fn new(
    ...
    Self {
      __program: program,
              ...
              rent: accounts.rent,
              one_time_printing_authorization_mint_authority: accounts.one_time_printing_authorization_mint_authority,
                    __args: args,
          }
  }
  #[inline(always)]
...
impl<'a, 'b> DeprecatedCreateMasterEditionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      /// Unallocated edition V1 account with address as pda of ['metadata', program id, mint, 'edition']
#[inline(always)]
    pub fn edition(&mut self, edition: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn mint(&mut self, mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Printing mint - A mint you control that can mint tokens that can be exchanged for limited editions of your master edition via the MintNewEditionFromMasterEditionViaToken endpoint
#[inline(always)]
    pub fn printing_mint(&mut self, printing_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.printing_mint = Some(printing_mint);
                    self
    }
      /// One time authorization printing mint - A mint you control that prints tokens that gives the bearer permission to mint any number of tokens from the printing mint one time via an endpoint with the token-metadata program for your metadata. Also burns the token.
#[inline(always)]
    pub fn one_time_printing_authorization_mint(&mut self, one_time_printing_authorization_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.one_time_printing_authorization_mint = Some(one_time_printing_authorization_mint);
                    self
    }
      /// Current Update authority key
#[inline(always)]
    pub fn update_authority(&mut self, update_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Printing mint authority - THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY.
#[inline(always)]
    pub fn printing_mint_authority(&mut self, printing_mint_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn rent(&mut self, rent: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// One time authorization printing mint authority - must be provided if using max supply. THIS WILL TRANSFER AUTHORITY AWAY FROM THIS KEY.
#[inline(always)]
    pub fn one_time_printing_authorization_mint_authority(&mut self, one_time_printing_authorization_mint_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.one_time_printing_authorization_mint_authority = Some(one_time_printing_authorization_mint_authority);
                    self
    }
                    #[inline(always)]
      pub fn create_master_edition_args(&mut self, create_master_edition_args: CreateMasterEditionArgs) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = DeprecatedCreateMasterEditionInstructionArgs {
                                                              create_master_edition_args: self.instruction.create_master_edition_args.clone().expect("create_master_edition_args is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          printing_mint: self.instruction.printing_mint.expect("printing_mint is not set"),
                  
          one_time_printing_authorization_mint: self.instruction.one_time_printing_authorization_mint.expect("one_time_printing_authorization_mint is not set"),
                  
          update_authority: self.instruction.update_authority.expect("update_authority is not set"),
                  
          printing_mint_authority: self.instruction.printing_mint_authority.expect("printing_mint_authority is not set"),
          ...
          one_time_printing_authorization_mint_authority: self.instruction.one_time_printing_authorization_mint_authority.expect("one_time_printing_authorization_mint_authority is not set"),
                          __args: args,
            };
...
struct DeprecatedCreateMasterEditionCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            edition: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                one_time_printing_authorization_mint_authority: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                        create_master_edition_args: Option<CreateMasterEditionArgs>,
