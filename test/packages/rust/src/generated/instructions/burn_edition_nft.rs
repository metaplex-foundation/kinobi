...
#[inline(always)]
    pub fn owner(&mut self, owner: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Mint of the print edition NFT
#[inline(always)]
    pub fn print_edition_mint(&mut self, print_edition_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.print_edition_mint = Some(print_edition_mint);
                    self
    }
      /// Mint of the original/master NFT
#[inline(always)]
    pub fn master_edition_mint(&mut self, master_edition_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.master_edition_mint = Some(master_edition_mint);
                    self
    }
      /// Token account the print edition NFT is in
#[inline(always)]
    pub fn print_edition_token_account(&mut self, print_edition_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.print_edition_token_account = Some(print_edition_token_account);
                    self
    }
      /// Token account the Master Edition NFT is in
#[inline(always)]
    pub fn master_edition_token_account(&mut self, master_edition_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.master_edition_token_account = Some(master_edition_token_account);
                    self
    }
      /// MasterEdition2 of the original NFT
#[inline(always)]
    pub fn master_edition_account(&mut self, master_edition_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.master_edition_account = Some(master_edition_account);
                    self
    }
      /// Print Edition account of the NFT
#[inline(always)]
    pub fn print_edition_account(&mut self, print_edition_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.print_edition_account = Some(print_edition_account);
                    self
    }
      /// Edition Marker PDA of the NFT
#[inline(always)]
    pub fn edition_marker_account(&mut self, edition_marker_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          print_edition_mint: self.instruction.print_edition_mint.expect("print_edition_mint is not set"),
                  
          master_edition_mint: self.instruction.master_edition_mint.expect("master_edition_mint is not set"),
                  
          print_edition_token_account: self.instruction.print_edition_token_account.expect("print_edition_token_account is not set"),
                  
          master_edition_token_account: self.instruction.master_edition_token_account.expect("master_edition_token_account is not set"),
                  
          master_edition_account: self.instruction.master_edition_account.expect("master_edition_account is not set"),
                  
          print_edition_account: self.instruction.print_edition_account.expect("print_edition_account is not set"),
                  
          edition_marker_account: self.instruction.edition_marker_account.expect("edition_marker_account is not set"),
