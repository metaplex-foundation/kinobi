...
pub mod cpi {
    ...
    pub struct ApproveCollectionAuthority<'a> {
    ...
    impl<'a> ApproveCollectionAuthority<'a> {
    ...
    pub struct ApproveCollectionAuthorityBuilder<'a> {
    ...
    impl<'a> ApproveCollectionAuthorityBuilder<'a> {
        ...
        pub fn build(&'a self) -> ApproveCollectionAuthority {
