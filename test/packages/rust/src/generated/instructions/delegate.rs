...
impl DelegateBuilder {
    ...
    pub fn build(&self) -> solana_program::instruction::Instruction {
        ...
        let args =
            DelegateInstructionArgs::new(self.delegate_args.expect("delegate_args is not set"));
...
pub mod cpi {
    ...
    impl<'a> DelegateBuilder<'a> {
        ...
        pub fn delegate_args(&'a mut self, delegate_args: DelegateArgs) -> &mut Self {
            self.delegate_args = Some(delegate_args);
            self
        }
        pub fn build(&'a self) -> Delegate {
            Delegate {
                ...
                args: DelegateInstructionArgs::new(
                    self.delegate_args.expect("delegate_args is not set"),
                ),
            }
        }
    }
