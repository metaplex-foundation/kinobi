...
impl CreateFrequencyRule {
  pub fn instruction(&self, args: CreateFrequencyRuleInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateFrequencyRuleInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(CreateFrequencyRuleInstructionData::new())).unwrap();
    ...
    let accounts = CreateFrequencyRule {
          ...
          let args = CreateFrequencyRuleInstructionArgs {
                                                              rule_set_name: self.rule_set_name.clone().expect("rule_set_name is not set"),
                                                                  freq_rule_name: self.freq_rule_name.clone().expect("freq_rule_name is not set"),
...
#[inline(always)]
    pub fn payer(&mut self, payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The PDA account where the Frequency Rule is stored
#[inline(always)]
    pub fn frequency_pda(&mut self, frequency_pda: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CreateFrequencyRuleInstructionArgs {
                                                              rule_set_name: self.instruction.rule_set_name.clone().expect("rule_set_name is not set"),
                                                                  freq_rule_name: self.instruction.freq_rule_name.clone().expect("freq_rule_name is not set"),
                                                                  last_update: self.instruction.last_update.clone().expect("last_update is not set"),
        ...
        __program: self.instruction.__program,
          ...
          frequency_pda: self.instruction.frequency_pda.expect("frequency_pda is not set"),
