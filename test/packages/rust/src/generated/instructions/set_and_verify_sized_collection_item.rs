...
#[derive(Clone)]
pub struct SetAndVerifySizedCollectionItemUnset;

pub struct SetAndVerifySizedCollectionItemBuilder<
    MetadataTypeParam = SetAndVerifySizedCollectionItemUnset,
    CollectionAuthorityTypeParam = SetAndVerifySizedCollectionItemUnset,
    UpdateAuthorityTypeParam = SetAndVerifySizedCollectionItemUnset,
    CollectionMintTypeParam = SetAndVerifySizedCollectionItemUnset,
    CollectionTypeParam = SetAndVerifySizedCollectionItemUnset,
    CollectionMasterEditionAccountTypeParam = SetAndVerifySizedCollectionItemUnset,
> {
...
impl
    SetAndVerifySizedCollectionItemBuilder<
        SetAndVerifySizedCollectionItemUnset,
        SetAndVerifySizedCollectionItemUnset,
        SetAndVerifySizedCollectionItemUnset,
        SetAndVerifySizedCollectionItemUnset,
        SetAndVerifySizedCollectionItemUnset,
