...
pub mod cpi {
    ...
    pub struct SetAndVerifySizedCollectionItem<'a> {
    ...
    impl<'a> SetAndVerifySizedCollectionItem<'a> {
    ...
    pub struct SetAndVerifySizedCollectionItemBuilder<'a> {
    ...
    impl<'a> SetAndVerifySizedCollectionItemBuilder<'a> {
        ...
        pub fn build(&'a self) -> SetAndVerifySizedCollectionItem {
