...
impl CreateRuleSet {
  pub fn instruction(&self, args: CreateRuleSetInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateRuleSetInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&(CreateRuleSetInstructionData::new())).unwrap();
    ...
    let accounts = CreateRuleSet {
          ...
          let args = CreateRuleSetInstructionArgs {
                                                              create_args: self.create_args.clone().expect("create_args is not set"),
                                                                  rule_set_bump: self.rule_set_bump.clone().expect("rule_set_bump is not set"),
                                    };
...
#[inline(always)]
    pub fn payer(&mut self, payer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The PDA account where the RuleSet is stored
#[inline(always)]
    pub fn rule_set_pda(&mut self, rule_set_pda: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CreateRuleSetInstructionArgs {
                                                              create_args: self.instruction.create_args.clone().expect("create_args is not set"),
                                                                  rule_set_bump: self.instruction.rule_set_bump.clone().expect("rule_set_bump is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          rule_set_pda: self.instruction.rule_set_pda.expect("rule_set_pda is not set"),
