...
pub struct OwnerSet;
#[derive(Clone)]
pub struct UseAssetArgsSet;
#[derive(Clone)]
pub struct UseAssetUnset;

pub struct UseAssetBuilder<
    MetadataTypeParam = UseAssetUnset,
    TokenAccountTypeParam = UseAssetUnset,
    MintTypeParam = UseAssetUnset,
    UseAuthorityTypeParam = UseAssetUnset,
    OwnerTypeParam = UseAssetUnset,
    UseAssetArgsTypeParam = UseAssetUnset,
> {
    ...
    >
{
    ...
    > {
        ...
        UseAssetBuilder {
            ...
            use_asset_args: self.use_asset_args,
    ...
    #[inline(always)]
    pub fn use_asset_args(
        mut self,
        use_asset_args: UseAssetArgs,
    ) -> UseAssetBuilder<
        MetadataTypeParam,
        TokenAccountTypeParam,
        MintTypeParam,
