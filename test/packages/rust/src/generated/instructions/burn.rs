...
/// Metadata of the Collection
#[inline(always)]
    pub fn collection_metadata(&mut self, collection_metadata: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
...
/// Metadata of the Collection
#[inline(always)]
    pub fn collection_metadata(&mut self, collection_metadata: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = BurnInstructionArgs {
                                                              burn_args: self.instruction.burn_args.clone().expect("burn_args is not set"),
                                    };
