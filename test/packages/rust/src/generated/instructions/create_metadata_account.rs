...
#[derive(Clone)]
pub struct MetadataBumpSet;
#[derive(Clone)]
pub struct CreateMetadataAccountUnset;

pub struct CreateMetadataAccountBuilder<
    MintTypeParam = CreateMetadataAccountUnset,
    MintAuthorityTypeParam = CreateMetadataAccountUnset,
    UpdateAuthorityTypeParam = CreateMetadataAccountUnset,
    DataTypeParam = CreateMetadataAccountUnset,
    IsMutableTypeParam = CreateMetadataAccountUnset,
    MetadataBumpTypeParam = CreateMetadataAccountUnset,
> {
    ...
    _phantom: std::marker::PhantomData<(
        ...
        DataTypeParam,
        IsMutableTypeParam,
        MetadataBumpTypeParam,
    )>,
}

impl
    CreateMetadataAccountBuilder<
        CreateMetadataAccountUnset,
        CreateMetadataAccountUnset,
        CreateMetadataAccountUnset,
        CreateMetadataAccountUnset,
        CreateMetadataAccountUnset,
