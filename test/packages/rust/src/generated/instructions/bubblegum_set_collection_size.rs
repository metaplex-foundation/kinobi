...
impl BubblegumSetCollectionSize {
  pub fn instruction(&self, args: BubblegumSetCollectionSizeInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: BubblegumSetCollectionSizeInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
/// Collection Authority Record PDA
#[inline(always)]
    pub fn collection_authority_record(&mut self, collection_authority_record: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = BubblegumSetCollectionSize {
          ...
          let args = BubblegumSetCollectionSizeInstructionArgs {
                                                              set_collection_size_args: self.set_collection_size_args.clone().expect("set_collection_size_args is not set"),
                                    };
...
#[inline(always)]
    pub fn collection_metadata(&mut self, collection_metadata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Collection Update authority
#[inline(always)]
    pub fn collection_authority(&mut self, collection_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
    pub fn collection_mint(&mut self, collection_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Signing PDA of Bubblegum program
#[inline(always)]
    pub fn bubblegum_signer(&mut self, bubblegum_signer: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
/// Collection Authority Record PDA
#[inline(always)]
    pub fn collection_authority_record(&mut self, collection_authority_record: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = BubblegumSetCollectionSizeInstructionArgs {
                                                              set_collection_size_args: self.instruction.set_collection_size_args.clone().expect("set_collection_size_args is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          collection_authority: self.instruction.collection_authority.expect("collection_authority is not set"),
                  
          collection_mint: self.instruction.collection_mint.expect("collection_mint is not set"),
                  
          bubblegum_signer: self.instruction.bubblegum_signer.expect("bubblegum_signer is not set"),
