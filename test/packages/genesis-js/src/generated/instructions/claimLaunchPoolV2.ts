...
// Accounts.
export type ClaimLaunchPoolV2InstructionAccounts = {
...
export function getClaimLaunchPoolV2InstructionDataSerializer(): Serializer<
...
> {
  return mapSerializer<
    ...
    ClaimLaunchPoolV2InstructionData
  >(
    struct<ClaimLaunchPoolV2InstructionData>(
      [
        ['discriminator', u8()],
        ['padding', array(u8(), { size: 7 })],
      ],
      { description: 'ClaimLaunchPoolV2InstructionData' }
    ),
...
// Args.
export type ClaimLaunchPoolV2InstructionArgs =
  ClaimLaunchPoolV2InstructionDataArgs;

// Instruction discriminator.
export const claimLaunchPoolV2InstructionDiscriminator = 70;

// Instruction.
export function claimLaunchPoolV2(
  context: Pick<Context, 'payer' | 'programs'>,
  input: ClaimLaunchPoolV2InstructionAccounts & ClaimLaunchPoolV2InstructionArgs
): TransactionBuilder {
  // Program ID.
  ...
  // Arguments.
  const resolvedArgs: ClaimLaunchPoolV2InstructionArgs = { ...input };
  ...
  // Data.
  const data = getClaimLaunchPoolV2InstructionDataSerializer().serialize(
    resolvedArgs as ClaimLaunchPoolV2InstructionDataArgs
  );
