...
export function transfer(
  ...
  // Token Owner.
  keys.push({
    pubkey: publicKey(resolvedAccounts.tokenOwner, false),
    isSigner: false,
  ...
  // Destination Owner.
  keys.push({
    pubkey: publicKey(resolvedAccounts.destinationOwner, false),
    isSigner: false,
  ...
  // Spl Ata Program.
  keys.push({
    pubkey: publicKey(resolvedAccounts.splAtaProgram, false),
    isSigner: false,
